...
class PersonRepoImplTest {
    ...
    void testGetByIdFound() {
        Mono<Person> personMono = personRepo.getById(3);
    ...
    void testFluxBlockFirst() {
        Flux<Person> personFlux = personRepo.getAll();
    ...
    @Test
    void testGetById() {
        Mono<Person> fionaMono = personRepo.getAll().filter(person -> person.getFirstName().equals("Fiona"))
                .next();
