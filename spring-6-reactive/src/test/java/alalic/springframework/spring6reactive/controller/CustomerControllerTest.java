...
import alalic.springframework.spring6reactive.model.CustomerDTO;
import alalic.springframework.spring6reactive.repo.CustomerRepoTest;
...
class CustomerControllerTest {
    ...
    void testPatchIdNotFound() {
        webTestClient.patch()
                ...
                .body(Mono.just(CustomerRepoTest.getTestCustomer()), CustomerDTO.class)
                .exchange()
    ...
    void testUpdateCustomerBadRequest() {
        Customer customerDto = CustomerRepoTest.getTestCustomer();
