...
import alalic.springframework.spring6mvc.services.BeerServiceImpl;
...
class BeerControllerTest {
    ...
    void testPatchBeer() throws Exception {
        BeerDTO beer = beerServiceImpl.listBeers(null, null, 1, 25).getContent().get(0);
    ...
    void testCreatedNewBeer() throws Exception {
        ...
        given(beerService.saveNewBeer(any(BeerDTO.class))).willReturn(beerServiceImpl.listBeers(null, null, 1, 25).getContent().get(1));
    ...
    void testListBeers() throws Exception {
        given(beerService.listBeers(any(), any(), any(), any())).willReturn(beerServiceImpl.listBeers(any(), any(), any(), any()));
    ...
    void getBeerById() throws Exception {
        BeerDTO testBeer = beerServiceImpl.listBeers(null, null, 1, 25).getContent().get(0);

        given(beerService.getBearById(any(UUID.class))).willReturn(Optional.of(testBeer));
